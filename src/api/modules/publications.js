...
async function publicationsGetList(Page,Rows){
  let result;
  result = await axios.get("https://as-humedal-api.azurewebsites.net/Publications/GetList?Page="+Page+"&Rows="+Rows)
  return result.data.data.items
}

async function publicationsGet(idPublications){
  let result;
  result = await axios.get("https://as-humedal-api.azurewebsites.net/Publications/Get?idPublicationsLanding="+publications)
...
async function updatepublications( publicationsToUpdate ){
  let result;
    result = await axios.put("https://as-humedal-api.azurewebsites.net/Publications/Update", publicationsToUpdate)
